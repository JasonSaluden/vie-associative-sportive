 ...
 */
final class Version20250304103349 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE licencie (id INT AUTO_INCREMENT NOT NULL, nom_licencie VARCHAR(255) NOT NULL, prenom_licencie VARCHAR(255) NOT NULL, photo_licencie VARCHAR(255) DEFAULT NULL, date_naissance DATE NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
